...
## Datasets Used / Planned (all free & open)

- [Fashion Clothing Products Catalog (Myntra, ~12k products)](https://www.kaggle.com/datasets/shivamb/fashion-clothing-products-catalog)  

  → Great for category/price/brand/rating EDA

- [Fashion Product Images (Small) (~44k items with images & metadata)](https://www.kaggle.com/datasets/paramaggarwal/fashion-product-images-small)  
